...
//            ', EDate ID: ' + edate);
    ...
    var url = '';
    url = config.URL + 'visibilityevaluations/visibilityshares';
...
//                        connectorColor: '#000000',
    ...
    //============= Element Performance =============//
    var epurl = config.URL + 'visibilityevaluations/elementperformance';
...
var mapurl = config.URL + 'visibilityevaluations/mapdata?' + param;
...
function getVisibilityDetailFromMap(id) {
    ...
    var veurl = config.URL + 'visibilityevaluations/mapitemdata/' + id;
    ...
    visibility_by_location.success(function(visibility_data) {
        ...
        for (var i = 0; i < visibility_data.length; i++) {
            ...
            html += '<td>' + visibility_data[i].brandelementname + '</td>';
    ...
    url = config.URL + 'visibilityevaluations/brandelementshare';
