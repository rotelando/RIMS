                ...
                <div class="span4">
                    ...
                    <div class="widget-box" style="padding: 15px;">
                        <div class="widget-header">
                            <h4><?php if (!isset($data['brandelements']['id'])) echo "Add New"; else echo "Edit"; ?> Merchandize</h4>
                        </div>

                        <div class="widget-body" style="padding: 15px;">

                            <?php echo $this->Form->create('Brandelement', array('method' => 'POST', 'controller' => 'brandelements', 'action' => 'add'));
                            ?>
                            <br />
                            ...
                            <?php
                            echo $this->Form->input('brandelementname', array('label' => 'Name', 'required' => true, 'placeholder' => 'Merchandize Name', 'class' => 'span10 left-stripe', 'type' => 'text'));
                            ?>
                            ...
                            <hr/>
                            <?php if (!isset($data['Brandelement']['id'])): ?>
                        ...
                        <tbody>
                            ...
                            foreach ($brandelements as $brandelement):
                                ...
                                <tr>
                                    ...
                                    <td> <?php echo $brandelement['Brandelement']['brandelementname']; ?>  </td>
                                    <td> <?php echo $brandelement['Brandelement']['weight']; ?>  </td>
                                    <td>
                                        <div class="hidden-phone visible-desktop action-buttons center">
                                            <?php
                                            echo $this->Html->link(
                                                    '<i class="icon-pencil bigger-130"></i>', 
                                                    array('controller' => 'brandelements', 'action' => 'edit', $brandelement['Brandelement']['id']), 
                                            ...
                                            echo $this->Html->link(
                                                    ...
                                                    array('controller' => 'brandelements', 'action' => 'delete', $brandelement['Brandelement']['id']), 
