    ...
    <div class="page-content">
        ...
        <div class="row-fluid">
            <div class="span12">
                <!--PAGE CONTENT BEGINS-->
                <!-- Start Form -->
                <?php echo $this->Form->create(null, array('method' => 'POST', 'controller' => 'settings', 'action' => 'changepassword', 'class' => 'form-horizontal')); ?>
                
                <?php // echo $this->Form->input('id', array('type' => 'hidden'));
                            ?>
                
                <fieldset class="default">
                    <legend>Change Password for <span class="text-info"><?php echo $fullname; ?></span></legend>
