                        ...
                        <fieldset class="default">
                            ...
                            <div class="span5">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="hours" placeholder="HH" class="span2 left-stripe">
                                        <input type="text" name="minutes" placeholder="MM" class="span2 left-stripe">
                                        <input type="text" name="seconds" placeholder="SS" class="span2 left-stripe">
                                    </div>
                                </div>
                            </div>
